...
const prevGetStateForActionHomeStack = Stack.router.getActiveRouteState

const Screens = ({ navigation, style, props }) => {
  console.log('current screen', prevGetStateForActionHomeStack)
  return (
