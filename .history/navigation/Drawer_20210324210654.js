...
const Screens = ({ navigation, style }) => {
  ...
  return (
    <Animated.View style={StyleSheet.flatten([styles.stack, style])}>
            ...
            <Button transparent onPress={() => navigation.openDrawer()}>
              <Feather
                ...
                style={{
                  ...
                  display:
                    history.location.pathname == '/StartScreen' ||
                    history.location.pathname == '/LoginScreen' ||
                    history.location.pathname == '/RegisterScreen' ||
                    history.location.pathname == '/ForgotPasswordScreen'
                      ? ''
                      : 'none',
                }}
              />
      ...
      >
        <Stack.Screen name="StartScreen"> {props => <StartScreen {...props} />} </Stack.Screen>
        <Stack.Screen name="LoginScreen"></Stack.Screen> {props => <LoginScreen {...props} />}</Stack.Screen>
        <Stack.Screen name="RegisterScreen"></Stack.Screen> {props => <RegisterScreen {...props} />}</Stack.Screen>
        <Stack.Screen name="Dashboard"></Stack.Screen> {props => <Dashboard {...props} />}</Stack.Screen>
        <Stack.Screen
